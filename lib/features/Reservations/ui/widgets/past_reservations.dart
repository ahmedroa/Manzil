...
class PastReservations extends StatelessWidget {
  final PastReservationsModel reservationList;

  const PastReservations({super.key, required this.reservationList});
